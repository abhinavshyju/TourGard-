...
class AcceptRequestTravellerView extends StatefulWidget {
  const AcceptRequestTravellerView({super.key});

  @override
  State<AcceptRequestTravellerView> createState() =>
      _AcceptRequestTravellerViewState();
}

class _AcceptRequestTravellerViewState
    extends State<AcceptRequestTravellerView> {
  ...
  Future<void> getdata() async {
    try {
      ...
      final Response response =
          await dio.get("$api/request/traveller/accept/$email");
