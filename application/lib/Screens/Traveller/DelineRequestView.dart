...
class DelineRequestTravellerView extends StatefulWidget {
  const DelineRequestTravellerView({super.key});

  @override
  State<DelineRequestTravellerView> createState() =>
      _DelineRequestTravellerViewState();
}

class _DelineRequestTravellerViewState
    extends State<DelineRequestTravellerView> {
  ...
  Future<void> getdata() async {
    try {
      ...
      final Response response =
          await dio.get("$api/request/traveller/deline/$email");
